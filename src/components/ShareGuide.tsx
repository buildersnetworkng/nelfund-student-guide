            ...
            >
              ...
              >
                ...
                <ol className="mt-3 space-y-1 text-[12px] leading-relaxed text-ink/55">
                  <li>1. Tap Post in class WhatsApp.</li>
                  <li>2. Choose the class or department group, not one classmate.</li>
                  <li>3. Send, then pin so students who join later still see it.</li>
                </ol>
