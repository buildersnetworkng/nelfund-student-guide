...
type Channel = {
  ...
  /** Tailwind-friendly accent for the icon tile */
  tile: string
...
type ShareGuideProps = {
  /** Compact icon button (header) vs larger CTA */
      ...
      {open && (
        <div className="fixed inset-0 z-[60] flex items-end justify-center sm:items-center" role="presentation">
          ...
          <div
            ...
            className="relative z-10 w-full max-w-md animate-in rounded-t-3xl border border-forest-100 bg-white p-5 shadow-2xl sm:rounded-3xl sm:p-6"
          ...
          >
            ...
            <div className="mt-4 grid grid-cols-3 gap-2.5 sm:grid-cols-3">
              {channels.map((ch) => (
                <button
                  key={ch.id}
                  type="button"
