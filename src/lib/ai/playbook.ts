...
export function playbookAnswer(intent: IntentId, ctx: PlaybookContext): string | null {
  if (ctx.userText) {
    const extra104 = playbookHourly104(intent, ctx.userText)
    if (extra104) return extra104
    const extra98 = playbookHourly98(intent, ctx.userText)
    if (extra98) return extra98
    const extra97 = playbookHourly97(intent, ctx.userText)
    if (extra97) return extra97
    const extra96 = playbookHourly96(intent, ctx.userText)
    if (extra96) return extra96
    const extra95 = playbookHourly95(intent, ctx.userText)
    if (extra95) return extra95
    const extra94 = playbookHourly94(intent, ctx.userText)
    if (extra94) return extra94
    ...
    if (extra87) return extra87
    const extra82 = playbookHourly82(intent, ctx.userText)
    if (extra82) return extra82
    const extra75 = playbookHourly75(intent, ctx.userText)
    if (extra75) return extra75
    ...
    if (extra72) return extra72
    const extra71 = playbookHourly71(intent, ctx.userText)
    if (extra71) return extra71
    const extra70 = playbookHourly70(intent, ctx.userText)
    if (extra70) return extra70
