...
const RULES: IntentRule[] = [
  // Capability-first intents (must outrank topic FAQs)
  {
    intent: 'email-draft',
    patterns: [
  ...
  { intent: 'academic-session', patterns: [/2026\s*\/?\s*27|2025\s*\/?\s*26|session/i, /can\s*i\s*still\s*apply/i], topics: ['session'], problem: 'Current application session or window', stage: 'exploring', entities: ['session'], troubleshooting: false, weight: 8 },
