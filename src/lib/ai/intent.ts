...
const RULES: IntentRule[] = [
  ...
  { intent: 'school-fees', patterns: [/school\s*fees/i, /institutional\s*charges/i, /will\s*nelfund\s*pay/i, /pay\s*(my\s*)?fees/i, /does\s*nelfund\s*pay\s*(school|fees)/i], topics: ['fees'], problem: 'How school fees / institutional charges are paid', stage: 'exploring', entities: ['fees'], troubleshooting: false, weight: 9 },
