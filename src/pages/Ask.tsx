    ...
    <div className="fixed inset-0 z-40 flex flex-col bg-paper">
      ...
      <div className="relative z-10 shrink-0 border-t border-forest-100 bg-paper px-3 py-3 sm:px-5">
        <div className="mx-auto max-w-2xl">
          ...
          <form
            onSubmit={onSubmit}
            className="relative flex items-end gap-2 rounded-2xl border border-forest-100 bg-white px-2 py-1.5 shadow-sm focus-within:border-forest-300 focus-within:ring-2 focus-within:ring-forest-500/20"
          >
            <div className="relative">
              ...
              {showAttachMenu && (
                <div className="absolute bottom-full left-0 z-20 mb-1 w-44 overflow-hidden rounded-xl border border-forest-100 bg-white shadow-lg">
                  <button
                    type="button"
